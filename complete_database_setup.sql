-- Complete RigSnap Database Setup Script
...
-- 12. Create trigger for users table updated_at
...
-- 13. Drop existing user creation function and trigger
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS handle_new_user();

-- 14. Create the user creation function with proper name construction
...
-- 17. Verify everything was created successfully
