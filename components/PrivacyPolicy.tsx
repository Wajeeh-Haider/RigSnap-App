      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.intro}>
          ...
          <Text style={[styles.introText, { color: colors.textSecondary }]}>
            At RigSnap, we`&apos;`re committed to protecting your privacy and
            being transparent about how we collect, use, and share your
            information. This policy explains our practices in clear, simple
            terms.
          </Text>
        ...
        <PolicySection icon={Database} title="Information We Collect">
          <PolicyText>
            ...
            gather automatically when you use our services.
          </PolicyText>
        ...
        <PolicySection icon={Share2} title="Information Sharing">
          <PolicyText>
            We share your information only in specific circumstances and never
        ...
        <PolicySection icon={Lock} title="Data Security">
          ...
          <PolicyText>
            ...
            use strong passwords and keep your account information confidential.
          </PolicyText>
        </PolicySection>
        ...
        <PolicySection icon={Shield} title="Your Rights and Choices">
          ...
          <PolicyText>
            ...
            remove your personal information within 30 days, except where
        ...
        >
          <Text style={[styles.footerText, { color: colors.textSecondary }]}>
            This privacy policy is effective as of January 2025 and may be
            updated from time to time. We`&apos;`ll notify you of any material
          ...
          >
            ...
            <View style={styles.footerActionText}>
              <Text
                style={[styles.footerActionTitle, { color: colors.primary }]}
              >
                Questions or Concerns?
              </Text>
              <Text
                style={[
                  styles.footerActionDescription,
                  { color: colors.primary },
                ]}
              >
                Our privacy team is here to help. Contact us anytime at
                privacy@rigsnap.com
              </Text>
            </View>
          </View>
